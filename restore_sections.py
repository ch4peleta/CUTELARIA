...
start_marker = '<section class="why-choose section-padding bg-darker">'
end_marker = '<!-- SEÇÃO 7: SOBRE O AUTOR -->'
...
new_sections = """    <section class="why-choose section-padding bg-darker">
        <div class="container">
...
new_content = content[:start_index] + new_sections + content[end_index:]
